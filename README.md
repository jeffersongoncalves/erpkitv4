...
![ERPKit v4](https://raw.githubusercontent.com/jeffersongoncalves/erpkitv4/main/art/jeffersongoncalves-erpkitv4.png)

</div>

# ERPKit v4

A full ERP on Filament v4 — a Laravel 13 + Filament v4 starter application with a multi-panel,
multi-guard architecture and the entire `jeffersongoncalves/filament-erp` ecosystem wired into its
admin panel.

ERPKit v4 follows the FilaKit multi-panel pattern: three Filament panels backed by two authentication
guards. The umbrella `jeffersongoncalves/filament-erp` plugin (the `2.x` / Filament-v4 line) registers
all 13 ERP modules on the **admin** panel, and a demo seeder lays down a coherent starting dataset so
you can log in and explore a working ERP in minutes.

> Looking for the Filament v5 edition? See [ERPKit v5](https://github.com/jeffersongoncalves/erpkitv5).
...
- **First-party Filament plugins** — Logo, Edit Profile, PWA, Log Viewer, Developer Logins, Additional Information, Sensible Defaults, Icon Picker
